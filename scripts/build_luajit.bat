...
:: Copy the generated .dll and .lib files to the destination path
echo Copying .dll and .lib files to %DEST_PATH%...
copy /Y src\*.dll %DEST_PATH%
copy /Y src\*.lib %DEST_PATH%
